(async function() {
        ...
        t11: async function(upazilaStr, FCStr) {
            ...
            await (async function ownerPart(upazila, FC) {
                ...
                async function selectMouza() {
                  ...
                  if (input) input.focus(); if (popBtn) popBtn.click(); await sleep(500); 
                ...
                for (let i = 0; i < owners.length; i++) {
                  ...
                  await sleep(200); clickButton("মালিক যোগ করুন"); await sleep(600); 
                } clickButton("মালিক এন্ট্রি সমাপ্ত করুন"); await sleep(500);
            })(upazila, FC);
            ...
            await (async function dagPart() {
                ...
                async function setById(id, value) {
                  ...
                  for (let t = 0; t < 3; t++) { reactSet(el, value); await sleep(150); if (norm(el.value) === norm(value)) break; } 
                }
                ...
                async function pickAuto(inputEl, optionText) {
                  if (!inputEl) return; inputEl.focus(); reactSet(inputEl, optionText); await sleep(300);
                ...
                async function pickSelect(labelStart, wantSubstr) {
                  ...
                  if (!trigger) return; trigger.focus(); trigger.dispatchEvent(new MouseEvent("mousedown", { bubbles: true })); trigger.click(); await sleep(300); 
    ...
    // 🔴 6. GLOBAL SHORTCUT HANDLER (FIXED FOR MULTIPLE PASTE)
